...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < 20; j++) {
            for (int i = 0; i < 20; i++) {
                int finalI = i;
                JPanel redSquarePanel = new JPanel();
                redSquarePanel.setBackground(Color.RED);

                redSquarePanel.setBounds(5 + i * 20, 5 + j * 20, 15, 15); //ustawienie pozycji i wymiarów kwadratu
                panel5.add(redSquarePanel);
            }
        }
